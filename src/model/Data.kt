...
class Data {
    ...
    var bookList  = mutableListOf<Book>(
        Book(4001 , "Lippincott Pharmacology" , 70 , "Pharmacology"  , "Whalen Karen" , "Whalen Karen" ,  LocalDate.of(2018 ,1,1), "English"),
        Book(4002 ,"Torab Almas" , 50, "Drama" ,"Ahmed Morad"  , "Dar Elshorouk" , LocalDate.of(2018 ,1,1) , "Arabic" ),
        Book(4003 ,"Roba'yat Salah Jahin", 80 , "Arabic literature" , "Salah Jahin" , "Maktabet Alosrah" , LocalDate.of(1959 ,1,1) , "Arabic" ),
        // Book(4004 , ),
        // Book(4005 , ),
    )
    ...
    var borrowedBooksList =  mutableListOf<Borrow>(
        Borrow(4001 , 2002 , LocalDate.of(2024 , 5 , 20 ) , LocalDate.of(2024 , 7 , 20 ) ),
        Borrow(4001 , 2001 , LocalDate.of(2024 , 5 , 21 ) , LocalDate.of(2024 , 7 , 21 ) ),
